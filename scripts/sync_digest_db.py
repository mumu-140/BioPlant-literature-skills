...
# common.py puts src/ on sys.path, so the package import below resolves.
from bio_literature_digest.db.schema import SCHEMA_STATEMENTS
...
def ensure_schema(connection: sqlite3.Connection) -> None:
    # DDL is owned by bio_literature_digest.db.schema (baseline 0001); see
    # migrations/0001_baseline_schema.py for the standalone entry point.
